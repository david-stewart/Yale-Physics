...
#define R__DICTIONARY_FILENAME OneVar_root_dict
...
namespace {
  void TriggerDictionaryInitialization_OneVar_root_dict_Impl() {
...
#line 1 "OneVar_root_dict dictionary forward declarations' payload"
...
#line 1 "OneVar_root_dict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("OneVar_root_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_OneVar_root_dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_OneVar_root_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_OneVar_root_dict() {
  TriggerDictionaryInitialization_OneVar_root_dict_Impl();
}

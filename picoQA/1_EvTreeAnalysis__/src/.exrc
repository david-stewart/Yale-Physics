...
set helplang=en
set ignorecase
set runtimepath=~/.config/nvim,~/.config/nvim/pack/minpac/start/xterm-color-table.vim,~/.config/nvim/pack/minpac/start/vim-unimpaired,~/.config/nvim/pack/minpac/start/vim-surround,~/.config/nvim/pack/minpac/start/vim-projectionist,~/.config/nvim/pack/minpac/start/vim-markdown-preview,~/.config/nvim/pack/minpac/start/vim-gfm-syntax,~/.config/nvim/pack/minpac/start/vim-fugitive,~/.config/nvim/pack/minpac/start/vim-eunuch,~/.config/nvim/pack/minpac/start/vim-commentary,~/.config/nvim/pack/minpac/start/vim-buftabline,~/.config/nvim/pack/minpac/start/julia-syntax.vim,~/.config/nvim/pack/minpac/start/fzf.vim,~/.config/nvim/pack/bundle/start/fzf,~/.config/nvim/pack/minpac/opt/minpac,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/home/tmp/.mount_MounAQ/usr/share/nvim/runtime,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,~/.config/nvim/pack/minpac/start/vim-gfm-syntax/after
set shiftwidth=4
set showtabline=2
set smartcase
set softtabstop=4

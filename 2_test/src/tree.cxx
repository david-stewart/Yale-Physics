...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../0_picoToEvTree/root/P16id/52BEE570E234E6E1DE80C69928D0A187_1596.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../0_picoToEvTree/root/P16id/52BEE570E234E6E1DE80C69928D0A187_1596.root");
      }
